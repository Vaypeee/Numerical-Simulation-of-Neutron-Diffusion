...
OBJ = main.o geometry.o prob.o residual.o critical.o plot.o euler.o mytime.o interface_primme.o
...
main.o: main.c main.h geometry.h prob.h residual.h critical.h plot.h euler.h mytime.h interface_primme.h
	$(CC) $(COPT) -c $< -o $@ $(INCP)
